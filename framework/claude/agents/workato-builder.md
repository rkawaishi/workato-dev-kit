...
| `workflow-app` | `.claude/rules/workato-page-components.md`, `workato-recipe-format.md` | `create-workflow-app` Phase 2 | `*.workato_db_table.json`, `*.lcap_page.json`, `*.lcap_app.json` |
