...
- `.cursor/rules/workato-agentic-format.mdc` — JSON structure for lcap_app / workato_db_table / lcap_page
...
File layout follows `.cursor/rules/workato-project-structure.mdc`.
