...
- `AGENTS.md` — lcap_app / workato_db_table / lcap_page の JSON 構造
...
生成ファイル (`*.lcap_app.json`, `Pages/`, `Data Tables/`, `Recipes/`, `Connections/`) は `projects/<project-name>/` に配置される。ワークスペースリポジトリでコミット:
