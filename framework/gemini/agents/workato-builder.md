...
|---|---|---|---|
| `recipe` | `GEMINI.md` | `create-recipe` Steps 7–9 + "Generation rules" | `*.recipe.json`, `*.connection.json` |
| `workflow-app` | `GEMINI.md`, `GEMINI.md` | `create-workflow-app` Phase 2 | `*.workato_db_table.json`, `*.lcap_page.json`, `*.lcap_app.json` |
| `genie` | `GEMINI.md` | `create-genie` generation sections | `*.agentic_genie.json`, `*.agentic_skill.json`, `*.mcp_server.json`, skill recipes |
| `connector` | `GEMINI.md` | `create-connector` "Rules for generating connector.rb" | `connector.rb` |
