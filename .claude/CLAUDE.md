...
Workato には「API Client」という名前の似て非なる 3 系統があり、混同すると設計自体をやり直すことになる。**設計に着手する前に必ず** 以下を読む:
1. `@docs/platform/workato-api-systems.md` — Developer API / API Platform Clients (v1/v2) / OEM の比較表と判断フロー
